...
const Lib = ({ color, width, height, isActiveSidebar }) => {
    return (
        <>
            {isActiveSidebar ? (
                <svg fill={color} width={width} height={height} data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 24 24" class="Svg-sc-ytk21e-0 bneLcE">
